...
<?php
	...
	if(isset($_POST['add'])){
        ...
        $numeroid = mysqli_real_escape_string($conn,(strip_tags($_POST['NumeroID'],ENT_QUOTES)));
        $fechan = mysqli_real_escape_string($conn,(strip_tags($_POST['FechaN'],ENT_QUOTES)));
        ...
        $estado_civil = mysqli_real_escape_string($conn,(strip_tags($_POST['EstadoC'],ENT_QUOTES)));
        $cargo = mysqli_real_escape_string($conn,(strip_tags($_POST['Cargo'],ENT_QUOTES)));
        $salario = mysqli_real_escape_string($conn,(strip_tags($_POST['Salario'],ENT_QUOTES)));
        $especialidad = mysqli_real_escape_string($conn,(strip_tags($_POST['Especialidad'],ENT_QUOTES)));
	
	$insert = mysqli_query($conn, "INSERT INTO tbl_empleado (Nom_Empleado, Cedula, Fec_Nacimiento, Tel_Empleado, Cel_Empleado, Dir_Empleado, ID_Sexo, ID_Est_Civil, ID_Cargo, Salario, ID_especialidad) 
