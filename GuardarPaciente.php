...
<?php
	...
	$insert = mysqli_query($con, "INSERT INTO tbl_pacientes (Nom_Paciente, ID_tipo_documento, cedula, Fec_Nacimiento, Edad, Email, Tel_Paciente, Cel_Paciente, Dir_Paciente, ID_Sexo, ID_Est_Civil, ID_Religion, ID_Tipo_Sangre, Contacto_Emergencia, ID_Parentesco, Tel_Emergencia, Cel_Emergencia, Antecedentes_Personales, Antecedentes_Hospitalarios, Antecedentes_Alergicos, Antecedentes_Familiares, Habitos) 
                                       VALUES ('$nombre', '$tipo_documento', '$numeroid', '$fechan', '$edad', '$email', '$telefono', '$celular', '$direccion', '$sexo', '$estado_civil', '$religion', '$sangre', '$contacto', '$parentesco', '$tel_emergencia', '$cel_emergencia', '$ant_personales', '$ant_hospitalarios', '$ant_alergicos', '$ant_familiares', '$habitos')") or die(mysqli_error());
    if($insert){
