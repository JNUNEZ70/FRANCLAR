    ...
    <?php
			...
			if(isset($_POST['save'])){
				...
				if($update){
                    ...
                    VALUES ('$id_usuario',12,'Update','SE ACTUALIZÓ UN ESTADO CIVIL')") or die(mysqli_error());
                        ...
                        <form method="POST" action="" autocomplete="off">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" onkeyup="mayus(this);" value="<?php echo $row['Descripcion_est_civil']; ?>" id="Nombre_Estado_Civil" maxlength="15"  name="Nombre" placeholder="Estado Civil" required>
                                </div>
