...
function Header()
{
    ...
    $this->Cell(50);
    // Título
    $this->Cell(100,10,utf8_decode('REPORTE DE DIAGNÓSTICOS'),0,0,'C');
    // Salto de línea
    $this->Ln(20);
}
...
$consulta = mysqli_query($con, "SELECT * FROM tbl_diagnosticos");
...
$pdf->Cell(170, 10, utf8_decode('Nombre del Diagnóstico'), 1, 1, 'C', 1);

while($row = mysqli_fetch_assoc($consulta)){
    $pdf->Cell(20, 10, $row['ID_Diagnostico'], 1, 0, 'C', 0);
    $pdf->Cell(170, 10, utf8_decode($row['Descripcion']), 1, 1, 'C', 0);
}
