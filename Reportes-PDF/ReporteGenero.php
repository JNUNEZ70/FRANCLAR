...
function Header()
{
    ...
    $this->Cell(50);
    // Título
    $this->Cell(100,10,utf8_decode('REPORTE DE GÉNERO'),0,0,'C');
    // Salto de línea
    $this->Ln(20);
}
...
if ($_GET['perl']) {
    ...
    $genero="SELECT * FROM tbl_sexo WHERE ID_Sexo LIKE '%".$buscar."%' OR Descripcion_sexo LIKE '%".$buscar."%'";
    
    $consulta = mysqli_query($con,$genero);
