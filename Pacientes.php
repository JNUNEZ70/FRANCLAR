                            ...
                            while($row = mysqli_fetch_assoc($sql)){
                                ...
                                <tr>
                                    <td>							
                                        ...
                                        <a href="Pacientes.php?aksi=delete&nik='.$row['ID_Paciente'].'" title="Eliminar" onclick="return confirm(\'¿Está seguro de borrar los datos del colaborador '.$row['Nom_Paciente'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                    </td>
