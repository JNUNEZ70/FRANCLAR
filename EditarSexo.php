    ...
    <?php
			...
			if(isset($_POST['save'])){
				...
				if($update){
                    ...
                    VALUES ('$id_usuario',16,'Update','SE ACTUALIZÓ UN GÉNERO')") or die(mysqli_error());
                        ...
                        <form method="POST" action="" autocomplete="off">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" onkeyup="mayus(this);" value="<?php echo $row['Descripcion_sexo']; ?>" id="Nombre_Sexo"  maxlength="15" name="Nombre" placeholder="Sexo" required>
                                </div>
