...
<?php
    ...
    if(isset($_POST['id'])){
        ...
        $cadena3 = '<input type="text" class="form-control" id="NumeroID" name="NumIDPac" onkeypress="return alfanumerica(event)" maxlength="15" placeholder="Número de identificación" readonly>';
