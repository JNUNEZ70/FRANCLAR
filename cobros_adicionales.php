...
<body>
    ...
    <?php
				...
				if(mysqli_num_rows($cek) == 0){
					...
					if($delete){
						$id_usuario= $_SESSION['ID_Usuario'];
                            ...
                            VALUES ('$id_usuario',23,'Delete','SE ELIMINÓ UN COBRO')") or die(mysqli_error());
	 ...
	 $sql=("SELECT * FROM tbl_permisos WHERE id_objeto=9 AND id_rol=$rolUsuario");
		...
		<form class="form-inline my-2 my-lg-0 float-left">
			<a class="genric-btn btn-danger circle" onclick="pdfDinamico(this)" id="pdf_cobros_adicionales" href="#">
